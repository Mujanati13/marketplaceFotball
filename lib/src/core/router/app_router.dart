        ...
        routes: [
            ...
            routes: [
              GoRoute(
                ...
                builder: (context, state) {
                  ...
                  print('=== ROUTER DEBUG ===');
                  print('Router extracted listing ID: $id');
                  print('=== ROUTER DEBUG END ===');
          ...
          GoRoute(
            ...
            routes: [
              GoRoute(
                ...
                builder: (context, state) {
                  final id = state.pathParameters['id']!;
                  return placeholder.MeetingDetailScreen(meetingId: id);
                },
              ),
            ],
          ),
          GoRoute(
            ...
            builder: (context, state) {
              ...
              return CreateMeetingScreen(requestId: requestId);
            },
          ),
          GoRoute(
